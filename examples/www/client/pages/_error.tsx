...
export default function Error(props: ReactPageProps) {
  ...
  const errorMessage = errorMap[status as keyof typeof errorMap] || "Unknown error";

  useHead({ title: `Error ${errorMessage}` });

  return (
    <>
      {/* center */}
      <div className="pt-20 pb-40 flex justify-center px-5 bg-base-100 min-h-screen">
        <div className="text-center w-full max-w-2xl">
          ...
          <p className="text-lg sm:text-lg mb-3 text-base-content/70">{errorMessage}</p>
          ...
          <a
            href="/"
            className="btn btn-primary btn-md rounded-lg mt-4"
            client-nav="true"
          >
            Go Back Home
          </a>
